...
pub use model::{
    ...
    InteractionItem, PaneId, PaneReport, PaneVisibility, Permission, ProgramToRun, Registration,
    RenderedView, SessionLayout, SidebarPaneReport, TabId, TabLayout, TabReport, UserAction,
    ViewAction,
};
